...
-   **[RESOLVED] COMPONENT SEPARATION**: Fixed bug where tank parts (turret, tracks) would drift from the hull. Synchronized all visual rotations and world-space offsets with the physics body simulation.
