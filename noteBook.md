...
-   **[2026-05-19 17:10]**: **v0.4.3 Hierarchy Fix & HP Bar Removal**. Removed HP bars as requested. Fixed hull-to-component separation bug by syncing all visual rotations and offsets directly with the physics body's actual orientation, eliminating the drift caused by manual rotation integration.
-   **[2026-05-19 17:05]**: **v0.4.2 Physics Stabilization**. Resolved "jittering" steering by switching from `SetRotation` to `SetAngularVelocity`. Decoupled visual banking (ground alignment) from physics to prevent jitter. Calibrated enemy physics body size to match 0.66x visual scale. 
